...
public interface IPaymentService {
    ...
    void setStatusBooking(UUID booking, PaymentStatus status) throws UnsupportedEncodingException;

    boolean notifyBooking(String vnp_ResponseCode, String vnp_TxnRef, String vnp_TransactionNo, String vnp_TransactionDate, String vnp_Amount) throws UnsupportedEncodingException;
}
