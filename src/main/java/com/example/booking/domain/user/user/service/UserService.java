...
import com.example.booking.domain.user.user.mapper.UserMapper;
...
import com.example.booking.domain.user.userOtp.repository.UserOtpRepository;
import com.example.booking.domain.user.userToken.entity.UserTokenEntity;
import com.example.booking.domain.user.userToken.repository.UserTokenRepository;
